...
public class IndentFile {
        ...
        public static void main(String[] arr) throws IOException {
            ...
            try {
                ...
                //PrintStream depends on the user. It can take 'System.out' or any other outputstream's as Parameter
       ...
       public static void indentate(FileInputStream fis, PrintStream out) throws IOException { 
            int s = 0;
            boolean flag = false, multiLineComment = false, line = false, singleQuote = false, doubleQuote = false;
            char c ='\0';
        ...
        public static void printSpaces(int indentate, PrintStream out) {
            out.println();
