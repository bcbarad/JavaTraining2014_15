...
class Student {
    ...
    int nsb , total;
    public static Student readMe(Scanner sc , final int nst , final int nsb) {
        Student s = new Student();
...
class Marks {
    int submarks;
    String subname;
    public static Marks readMe(Scanner sc , final int nst) {
        Marks m = new Marks();
...
class Total {
    public static void displayMax(final int stucount , StudentMarks sm) {
        int high = 0;
        String highname = "";
