...
public class Company {
	...
	public void readEmployeesData(String cEO){
		...
		Employee hrManager = new Employee(101, "Bikash", 100000, hr,new Date("12/3/1985"));
		hr.setDeptManager(hrManager);
		Employee developmentManager = new Employee(102, "Tarun", 100000, development,new Date("6/7/1982"));
		development.setDeptManager(developmentManager);

		Employee lova = new Employee(103, "Lova", 10000, hr,new Date("2/4/1986"));
		
		
		
		Employee lavanya = new Employee(104, "Lavanya", 10000, hr,new Date("8/5/1985"));
		Employee dheeraja=new Employee(125,"Dheraja",10000,hr,new Date("9/7/1990"));
		Employee abhi = new Employee(105, "Abhi", 10000, development,new Date("6/25/1991"));
		Employee ashok = new Employee(106, "Ashok", 10000, development,new Date("3/5/1993"));
		Employee alok = new Employee(107, "Alok", 10000, development,new Date("3/28/1992"));
		...
		Employee keerthi = new Employee(108, "Keerthi", 9600, hr,new Date("7/19/1990"));
		Employee gaurav = new Employee(109, "Gaurav", 9600, hr,new Date("10/29/1989"));
		Employee deepika = new Employee(110, "Deepika", 9600, hr,new Date("6/4/1997"));
		Employee pawan = new Employee(111, "Pawan", 9600, development,new Date("2/14/1993"));
		...
		Employee rajeev = new Employee(112, "Rajeev", 7500, hr,new Date("13/4/1987"));
		Employee ram = new Employee(113, "Ram", 7500, hr,new Date("19/4/1986"));
		Employee sasanka = new Employee(114, "Sasanka", 7500, hr,new Date("04/4/1989"));
		Employee sambit = new Employee(115, "Sambit", 7500, hr,new Date("09/4/1980"));
		Employee yasodhara = new Employee(116, "Yasodhara", 7500, development,new Date("20/4/1987"));
		Employee binita = new Employee(117, "Binita", 7500, development,new Date("26/4/1983"));
		Employee anil = new Employee(118, "Anil", 7500, development,new Date("22/4/1981"));
